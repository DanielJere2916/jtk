...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $photo = 'images/default_photo.jpg'; // Default photo path
        ...
        $sql2 = "INSERT INTO user_profiles (user_id, first_name, last_name, phone, address, city, photo) VALUES (?, ?, ?, ?, ?, ?, ?)";
        $stmt2 = mysqli_prepare($conn, $sql2);
        mysqli_stmt_bind_param($stmt2, "issssss", $user_id, $first_name, $last_name, $phone, $address, $city, $photo);
...
<div class="modal" id="responseModal">
    <div class="modal-content">
        ...
        <h2 id="modalTitle"></h2>
        <p id="modalMessage"></p>
        <button class="modal-close" onclick="closeModal()">Verify Now</button>
    </div>
</div>
    ...
    <div class="container">
        ...
        <div class="form-grid">
            <div class="form-group">
                <label for="first_name"><b>Legal First Name</b></label>
                <input type="text" placeholder="Enter First Name" name="first_name" id="first_name" required>
            </div>
            
            <div class="form-group">
                <label for="last_name"><b>Legal Last Name</b></label>
