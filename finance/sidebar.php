...
<div class="sidebar">
    ...
    <a href="#appointments"><i class="fas fa-calendar-alt"></i> Bills & Invoces</a>
    <a href="cases.php"> <i class="fas fa-briefcase"></i> Users</a>
    ...
    <div class="content">
        ...
        <div class="services-grid">
            <div class="service-card">
                <h3><i class="nav-icon"><img src="../assets/fonts/invoice.png" alt="greet"></i> Total Invoices</h3><hr>
                <p>0</p>
            </div>
            <div class="service-card">
                <h3><i class="nav-icon"><img src="../assets/fonts/activepa.png" alt="greet"></i> Active Payments</h3><hr>
            <?php
            ...
            <div class="service-card">
                <h3><i class="nav-icon"><img src="../assets/fonts/pays.png" alt="greet"></i> Total Payments </h3><hr>
                <p>0</p>
            </div>
        </div>
    </div>
        ...
        <table>
            ...
            $status_colors = [
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<tr><td colspan='6'>No recent payment found</td></tr>";
                }
