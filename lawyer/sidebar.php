    ...
    <div class="content">
        ...
        <div class="services-grid">
            <div class="service-card">
                <h3><i class="nav-icon"><img src="../assets/fonts/rec.png" alt="greet"></i> Open Cases</h3><hr>
                <p>1</p>
            </div>
            <div class="service-card">
                <h3><i class="nav-icon"><img src="../assets/fonts/case.png" alt="greet"></i> Assigned Cases</h3><hr>
            <?php
           ...
           $user_id = 1;
            ...
            <div class="service-card">
                <h3><i class="nav-icon"><img src="../assets/fonts/settle.png" alt="greet"></i> Settled Cases</h3><hr>
                <p>0</p>
            </div>
        </div>
    </div>
